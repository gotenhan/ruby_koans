...
class AboutClasses < EdgeCase::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # Why is this so?
    #
    # initialize is treated as ordinary private method
    # new allocates memory and then calls initialize to set object up
    # you can call initialize on object any time using send, e.g. fido.send(initialize, 'Fido')
  end
