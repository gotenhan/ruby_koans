...
class AboutClassMethods < EdgeCase::Koan
  ...
  #
  # I prefer the method with << because it allows to define multiple class methods without repeating self
  # The self.method_name is more verbose, though, and shorter if we define only one method.
