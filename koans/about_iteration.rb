...
class AboutIteration < EdgeCase::Koan
  ...
  def test_find_locates_the_first_element_matching_a_criteria
    ...
    #this does not test if it finds _first_ element, because there is only one item with size > 4
    #if find returned last item, this test would also pass
  end
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # the same what foldl in Haskell/other functional languages does
    # [a, b, c, d].inject x,&op = op(op(op(op((op x, a), b), c), d)
  end
